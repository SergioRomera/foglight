...
--/*  Usage:        Activate using: db2 connect to <dbname>; db2 -tvf <DB2_grant_Permissions_v10.sql>             */
--/*	Date Created:	16/01/2014.																														                        */
--/*	Last Modified:																																	                            */
--/****************************************************************************************************************/
-- grant version 10 specific permissions
   ...
   grant execute on function SYSPROC.WLM_GET_SERVICE_CLASS_AGENTS(VARCHAR(128),VARCHAR(128), BIGINT,INTEGER) TO USER @quest_replace_user;
